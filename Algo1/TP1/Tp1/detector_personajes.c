...
const char BLUE = 'F'; // F porque es un fantasma
...
void valor_multiplicador_zapatos(int* multiplicador)
{
    ...
    if (talla_zapatos == 0) *multiplicador = 1;
...
** a su nombre. */
void detectar_personaje(int puntaje_final, int altura_ingresada, char* personaje_detectado)
{
...
{
    printf("\nLuego de extensos calculos, el Detectron3000 a detectado a ");
...
int main()
{
    ...
    detectar_personaje(puntaje_total, altura, &personaje_detectado);
